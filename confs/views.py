...
class ConferenceView(LoginRequiredMixin, DetailView):

    model = Conference
    template_name = 'conference.html'


class CreateConferenceView(UserPassesTestMixin, CreateView):
...
class UpdateConferenceView(UserPassesTestMixin, UpdateView):
...
class DeleteConferenceView(UserPassesTestMixin, DeleteView):
...
class ConferenceRegister(LoginRequiredMixin, View):
...
class ConferenceSubscribe(LoginRequiredMixin, View):
